(function webpackUniversalModuleDefinition(root, factory) {
    ...
    return  (function(modules) {
        ...
        (function(module, exports, __webpack_require__) {
            ...
            var url_1 = __webpack_require__("./build/url.js");
            var manager_1 = __webpack_require__("./build/manager.js");
            var socket_1 = __webpack_require__("./build/socket.js");
            Object.defineProperty(exports, "Socket", {enumerable: true, get: function get() { return socket_1.Socket; }});
            var debug = __webpack_require__("./node_modules/debug/src/browser.js")("socket.io-client");
            module.exports = exports = lookup;
            var cache = exports.managers = {};
            function lookup(uri, opts) {
                if (_typeof(uri) === "object") { opts = uri; uri = undefined; }
                opts = opts || {};
                ...
                var io;
                if (newConnection) { debug("ignoring socket cache for %s", source); io = new manager_1.Manager(source, opts); } else {
                    if (!cache[id]) { debug("new io instance for %s", source); cache[id] = new manager_1.Manager(source, opts); }
                    io = cache[id];
                }
            ...
            enumerable: true,
            get: function get() { return socket_io_parser_1.protocol; }
            });
            /**
             * `connect`.
             *
        ...
        (function(module, exports, __webpack_require__) {
            ...
            var socket_1 = __webpack_require__("./build/socket.js");
            var parser = __webpack_require__("./node_modules/socket.io-parser/dist/index.js");
            var on_1 = __webpack_require__("./build/on.js");
            var Backoff = __webpack_require__("./node_modules/backo2/index.js");
            var typed_events_1 = __webpack_require__("./build/typed-events.js");
            var debug = __webpack_require__("./node_modules/debug/src/browser.js")("socket.io-client:manager");
            var Manager = function (_typed_events_1$Stric) {
                ...
                function Manager(uri, opts) {
                    ...
                    _this.nsps = {};
                    _this.subs = [];
                    if (uri && "object" === _typeof(uri)) { opts = uri; uri = undefined; }
                    opts = opts || {};
                    ...
                    _this.backoff = new Backoff({ min: _this.reconnectionDelay(), max: _this.reconnectionDelayMax(), jitter: _this.randomizationFactor() });
